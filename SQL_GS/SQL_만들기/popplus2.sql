...
AND A15.DATECD BETWEEN TO_DATE('2021-01-01', 'YYYY-MM-DD') AND TO_DATE('2021-03-16','YYYY-MM-DD') 
GROUP BY A14.RGNCD
        ,a14.rgnnm
        ,A13.TEAMCD
        ,a13.team_ln
