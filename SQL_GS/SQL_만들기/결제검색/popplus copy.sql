...
select	distinct a11.STORECD  STORECD,
	SUBSTR(a11.STORENM,1,INSTR(a11.STORENM,'(')-1 )  STORENM,
	'V'||SUBSTR(a11.STORENM,INSTR(a11.STORENM,'(')+1, -( INSTR(a11.STORENM,'(') -INSTR(a11.STORENM,':'))-1)  CustCol_31,
	a12.CLUSTER1  CLUSTER1,
	a12.CLUSTER1_NM  CLUSTER1_NM,
	a11.posi_type  posi_type0
from	LGMJVDP.TB_STORE_DM	a11
	join	LGMJVDP.TB_STORE_CLSTR_DM	a12
...
SELECT  A14.RGNCD AS 지역팀코드
        ...
        ,A12.posi_type  posi_type0
        ,a99.CLUSTER1_NM  CLUSTER1_NM
...
LEFT JOIN LGMJVDP.TB_STORE_CLSTR_DM a99
ON a12.STORECD = a99.STORECD
