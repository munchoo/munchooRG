...
SELECT    A.OPER_DT
 ...
 WHERE    A.OPER_DT BETWEEN REPLACE('2021-11-15','-','') AND REPLACE('2021-11-21','-','')
...
SELECT    A.OPER_DT
 ...
 WHERE    A.OPER_DT BETWEEN REPLACE('2021-11-15','-','') AND REPLACE('2021-11-21','-','')
   ...
   AND    A.GOODS_CD IN ('88002798     ', '8801062623471', '8801104221467', '8801121771402')   
...
GSRSAV AS (
  SELECT    ORIGIN_BIZPL_CD
   ...
   WHERE    OPER_DT BETWEEN REPLACE('2021-11-15','-','') AND REPLACE('2021-11-21','-','')
